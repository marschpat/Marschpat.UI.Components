...
const UploadOverview = ({ musicPieces, onMetadataEditClick, onInstrumentSheetsUpdate }) => {
    ...
    useEffect(() => {
        ...
        if (originalFiles) {
            ...
            onInstrumentSheetsUpdate(allInstrumentSheets, selectedMusicPieceIndex);
    ...
    return (
        <section className="block w-full h-full p-6 mr-6 bg-gray-200  border border-gray-200 shadow pb-24">
            ...
            <div className="flex flex-col pl-16">
                <IconButton style={{ right: 0 }} onClick={handleUploadFileClick}></IconButton>
            </div>
        </section>
    );
