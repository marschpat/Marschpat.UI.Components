    ...
    return (
        <div className="mb-10">
            <div className="flex justify-between items-center">
                <Typography variant="h6" className="text-gray-700 font-semibold">MXL Vorschau</Typography>
                <TooltipStyled
                    title="Achtung: Die Anzahl der Seiten ist von der Taktanzahl und Ihren Einstellungen (Skalierung, Notenabstand) abhängig. Fürs Marschieren empfehlen wir die Noten auf eine Seite zu skalieren"
                >
                    <div className="cursor-pointer">
                        {props.pagesCount && <Typography className="text-gray-500 text-lg font-semibold">Anzahl Seiten: {props.pagesCount}</Typography>}
                    </div>
                </TooltipStyled>
                <MxlInfoButton />
            </div>
